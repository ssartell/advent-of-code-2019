...
const binarySearch = require('../graph-traversal/binarySearch');
...
const find = map => {
    return binarySearch(0, 1000000000000, x => Math.sign(minimumChemical('FUEL', x, new Map(), map) - 1000000000000));
}

const solution = R.pipe(parseInput, toReactionsMap, find);
